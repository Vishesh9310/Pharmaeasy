...
import dir from '../assets/direction_icon.svg'
import face1 from '../assets/face_doctor.jpg'
...
function Gallery() {
  ...
  return (
    <>
      ...
      <section className='bg-[url(C:\Users\Chauh\pharmaeasy\src\assets\hospital3.jpg)] bg-cover'>
