        ...
        <>
            ...
            <section className='bg-sky-200 h-fit pb-40'>
                ...
                <div className='bg-sky-300 text-white inline-flex'>
                    <div className='bg-none hover:bg-sky-400 h-fit w-1/3 pl-24 pr-4 pb-6'>
                        ...
                        <button className='bg-none border-white border-2 rounded py-1 px-4 hover:bg-sky-300'>Click Here <span>&gt;&gt;</span></button>
                    </div>
                    <div className='bg-none hover:bg-sky-400 h-fit w-1/3 pb-6 px-4'>
                        <img src={nurshing_care} alt="hello" className='h-20 w-24 p-2' />
                        <h2 className='font-bold text-3xl py-3'>Doctor Consultant</h2>
                        <p className='leading-tight pb-4'>“No matter how slow you go you're still lapping everyone on the couch.”</p>
                        <button className='bg-none border-white border-2 rounded py-1 px-4 hover:bg-sky-300'>Click Here <span>&gt;&gt;</span></button>
                    </div>
                    <div className='bg-none hover:bg-sky-400 h-fit w-1/3 pr-24 pl-4 pb-6'>
